...
const FacultyCardImage = (props: CardProps): JSX.Element => {
  return (
    ...
    >
      <div className=" lg:w-1/2  ">
        <div className="py-6">
          ...
          <img
            src={props.link}
            alt={props.name}
            className="rounded-lg h-80 w-80 md:h-64 md:w-64 hover:brightness transition-all duration-500 ease-in-out"
          />
        </div>
      ...
      {props.description && <div className="relative text-white gap-4 p-2 lg:p-10 w-full h-full flex items-start italic text-lg lg:text-xl font-extralight justify-center flex-col">
