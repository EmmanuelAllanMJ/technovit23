  ...
  return (
    <>
      <section className="flex flex-wrap justify-between px-32 text-white font-monty py-4">
        <section className="flex flex-col gap-4 md:py-8">
        ...
        <section className="flex flex-col uppercase font-monty text-white gap-[40px] text-3xl md:text-2xl sm:text-xl md:py-8 sm:py-8 sm:border-white sm:border-t-white">
