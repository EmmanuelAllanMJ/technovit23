  ...
  return (
    <section className={`${props.className} font-monty py-4`}>
      <section className="flex flex-col border lg:mx-32 md:mx-16 sm:mx-8 border-t-0 border-b-2 border-r-2 border-l-2 rounded-lg border-white">
        <h1 className="flex w-full justify-center bg-clip-text text-transparent bg-gradient-to-tl from-stone-600 to-white text-center mx-auto text-6xl md:text-3xl sm:text-xl uppercase my-16">
