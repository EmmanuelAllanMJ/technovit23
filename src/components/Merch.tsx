    ...
    <>
      <div className="relative min-h-screen" id="events">
        ...
        <div className="flex justify-center items-center relative z-10">
          <section className="pt-4 md:text-center sm:text-center mb-10 lg:px-32 sm:px-8 md:px-16 text-6xl font-opensans bg-clip-text text-transparent bg-gradient-to-t from-stone-600 to-white uppercase">
            <br/><br/>
            MERCH
            <br/><br/>
          </section>
        </div>
        <div className="font-opensans relative z-10">
