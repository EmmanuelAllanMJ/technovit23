...
const About = () => {
  return (
    <div className="">
      <div className="flex  lg:px-40 md:px-24 sm:px-14 md:pt-60 sm:pt-10 h-screen flex-col justify-center">
        <div className="mt-8">
          <h2 className="font-monty bg-clip-text text-transparent bg-gradient-to-tl from-stone-600 to-white text-center text-8xl md:text-6xl sm:text-4xl uppercase">
            About technoVIT
          </h2>
        </div>
        <div className="grid place-items-center">
          <p className=" text-neutral-100 font-monty font-extralight text-justify  lg:w-10/12 text-3xl md:text-2xl sm:text-lg !leading-normal pt-10">
