    ...
    <>
      <div className="flex px-32 md:px-28 sm:px-16  flex-col justify-center mt-12 mb-16" id="about">
        <div className="">
          ...
          <div className="flex items-center justify-center px-8 py-4 bg-gradient-to-br from-[#544374]/40 to-[#0D0626]/40 rounded-xl border border-[#544374]/40">
        ...
        <div className="grid place-items-center">
          ...
          <p className="z-10 text-neutral-100 font-monty font-extralight text-justify w-full tracking-widest md:text-justify mt-6 lg:w-10/12 text-4xl md:text-3xl sm:text-xl pt-4">
