...
const About = () => {
  return (
    <div>
        <div className="flex justify-between md:flex-col md:gap-6 sm:flex-col sm:gap-4 px-32 md:px-28 sm:px-16 py-4">
          {/* left */}
          <div className="lg:w-4/12">
            <h2 className="font-monty bg-clip-text text-transparent bg-gradient-to-t from-stone-600 to-white text-center  text-8xl md:text-6xl sm:text-5xl  ">ABOUT</h2>
          </div>
          {/* right */}
          <div className='lg:w-8/12'>
            <p className=" text-neutral-100 font-monty font-extralight text-justify text-3xl md:text-2xl sm:text-lg !leading-tight">
