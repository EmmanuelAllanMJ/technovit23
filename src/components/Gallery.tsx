...
const Gallery: React.FC = () => {
  ...
  <div className="absolute top-0 left-0 w-full h-1/4 bg-gradient-to-b from-[#030014] to-transparent" />
  <div className="absolute bottom-0 left-0 w-full h-1/4 bg-gradient-to-b from-transparent to-[#030014]" />
</section>
